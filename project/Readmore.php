...
$EID=$_POST['EID'];
$sql="SELECT topic,details,photo,date_and_time,published_time FROM events WHERE event_id='$EID' LIMIT 1";
$result=mysqli_query($connection,$sql);

if ($result==true){
    $display=mysqli_fetch_assoc($result);

    $db_date = date_create($display['date_and_time']);
...
<head>
    ...
    <title>ReadMore - NSBM Community Portal</title>
...
<?php  echo '<img alt="Event Image" src="data:image/jpeg;base64,'.base64_encode($display['photo']).'" style="height:400px; width:100%;" />'; ?>

    <h1 class="readmore_header"><?php echo $display['topic']; ?></h1>

    <div class="text_area">
        <h4 class="d_t">Coming up on <?php  echo $new_date; ?></h4>
        <br>
        <p class="readmore_details"><?php echo $display['details']; ?></p>
        <br>
        <p style="color: #878787;">Published on <?php  echo $display['published_time']; ?></p>
