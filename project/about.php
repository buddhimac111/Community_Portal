...
<head>
    ...
    <title>About us - NSBM Community Portal</title>
...
<div class="section">
    ...
    <div class="containerr">
        <div class="content-section">
            ...
            <center><img style="width: 500px;" src="Logo.png" alt="Logo"></center>
            <br><br>
            <h2 class="head">Who are we?</h2>
            <div class="content">
                <h3> <p>We bring all the upcoming events of NSBM Clubs & Socities to one place inorder for students to be readily updates on the latest events of the universty.Our goal is to help students Track on their favoured society and to help the socities to inform their upcoming events easily to the whole NSBM student community.  </p></h3>
                <br>
            </div>
        </div>
    </div>
    <div class="containerr">
        <div class="content-section">
            ...
            <h2 class="head">What do we do?</h2>
            <div class="content">
                <h3>  <p>Community prtal let you know all the upcoming events of university clubs and socities.You can create your own account and add all your favourites.
                        Share your club's events and be informd about the events of other socities.
                        <br>
                        <br>
                    </p>  </h3>
                <br>
