...
{
    $cover = addslashes(file_get_contents($_FILES['cp']['tmp_name']));
    ...
    $sql_publish="INSERT INTO events (topic,details,photo,date_and_time) VALUES ('$topic','$details','$cover','$date_time') LIMIT 1";
...
<form name="events_publish" method="post" enctype="multipart/form-data" action="add_event.php" >
  ...
  margin-left: auto;">
        ...
        <div class="form-group">
            ...
            <input type="text" name="topic" class="form-control" id="event_name" placeholder="Event Name / Topic" autofocus required>
        </div>
        <br>
        <div class="form-group">
            ...
            <tr>
                ...
                <td style="width: 600px;" >
                    ...
                    <center><label class="btn btn-primary ">
                            Upload a Cover Photo<input  accept="image/*" type="file" id="imgInp" name="cp" hidden  onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])" required>  </label></center>
                </td>
            </tr>
